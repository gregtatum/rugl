...
fn main() {
    ...
    let draw = rugl!(rugl.draw, {
        ...
        attributes => {
            ...
            normal => &angle_normals::compute(teapot::CELLS, teapot::POSITIONS)
        },
        ...
        uniforms => {
            ...
            model => {
                ...
                move |env| Box::new(mat4::rotate_y(&identity, env.time as f32))
            },
            view => {
            ...
            projection => {
                move |env| {
                    ...
                    let fovy = 1.0;
                    Box::new(mat4::perspective(fovy, aspect, 0.1, 1000.0))
                }
            }
        }
    });
